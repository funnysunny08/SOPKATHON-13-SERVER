...
public class CalendarUtil {
     ...
     * @return
     */
    public static List<Integer> getCurrentWeekOfMonth(int year, int month, int day)  {
        ...
        result.add(calendar.get(Calendar.MONTH) + 1);
        result.add(dayOfWeekForFirstDayOfMonth);
        return result;
    }
